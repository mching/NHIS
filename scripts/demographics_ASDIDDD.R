...
table(x.sa$INCOME, isASD, useNA = "ifany")
svymean(~INCOME, ASD.design, na.rm = T)
confint(svymean(~INCOME, ASD.design, na.rm = T))
table(x.sa$INCOME, isID, useNA = "ifany")
svymean(~INCOME, ID.design, na.rm = T)
confint(svymean(~INCOME, ID.design, na.rm = T))
table(x.sa$INCOME, isDD, useNA = "ifany")
svymean(~INCOME, DD.design, na.rm = T)
confint(svymean(~INCOME, DD.design, na.rm = T))

# Education
table(x.sa$EDUCATION, useNA = "ifany")
svymean(~EDUCATION, cam.design, na.rm = T)
confint(svymean(~EDUCATION, cam.design, na.rm = T))
table(x.sa$EDUCATION, isASD, useNA = "ifany")
svymean(~EDUCATION, ASD.design, na.rm = T)
confint(svymean(~EDUCATION, ASD.design, na.rm = T))
table(x.sa$EDUCATION, isID, useNA = "ifany")
svymean(~EDUCATION, ID.design, na.rm = T)
confint(svymean(~EDUCATION, ID.design, na.rm = T))
table(x.sa$EDUCATION, isDD, useNA = "ifany")
svymean(~EDUCATION, DD.design, na.rm = T)
confint(svymean(~EDUCATION, DD.design, na.rm = T))
