...
##########################################################################
# Sections on tables and svymean and confints are commented out to make run faster
# when loading but are required for calculating estimates for the means and 
# confidence intervals for each cam_topic
##########################################################################
...
# Update designs
cam.design <- update(cam.design, CHELATION = x.sa$cch_use_r == 1)
...
# Update designs
cam.design <- update(cam.design, HOMEOPATHY = x.sa$chm_use_r == 1)
ASD.design <- subset(cam.design, isASD)
DD.design <- subset(cam.design, isDD)
ID.design <- subset(cam.design, isID)
ASDDDID.design <- subset(cam.design, isASDDDID)
...
# Update designs
cam.design <- update(cam.design, TRADHEALER = x.sa$ctr_evr_r == 1)
ASD.design <- subset(cam.design, isASD)
DD.design <- subset(cam.design, isDD)
ID.design <- subset(cam.design, isID)
ASDDDID.design <- subset(cam.design, isASDDDID)
...
# 
# # no ASD, ID, DD
# svymean(~TRADHEALER, noASDDDID.design, na.rm = T)
# confint(svymean(~TRADHEALER, noASDDDID.design, na.rm = T))
######################################################################
...
# Update designs
cam.design <- update(cam.design, BIOFEEDBACK = x.sa$cbi_use_r == 1)
ASD.design <- subset(cam.design, isASD)
DD.design <- subset(cam.design, isDD)
ID.design <- subset(cam.design, isID)
ASDDDID.design <- subset(cam.design, isASDDDID)
...
# # no ASD, ID, DD
# table(BIOFEEDBACK = x.sa$cbi_use_r, asdddid = isASDDDID, useNA = "if")
# svymean(~BIOFEEDBACK, noASDDDID.design, na.rm = T)
# confint(svymean(~BIOFEEDBACK, noASDDDID.design, na.rm = T))
...
# Update designs
cam.design <- update(cam.design, CRANIOSACRAL = x.sa$ccs_use_r == 1)
ASD.design <- subset(cam.design, isASD)
DD.design <- subset(cam.design, isDD)
ID.design <- subset(cam.design, isID)
ASDDDID.design <- subset(cam.design, isASDDDID)
...
# 
# # no ASD, ID, DD
# svymean(~CRANIOSACRAL, noASDDDID.design, na.rm = T)
# confint(svymean(~CRANIOSACRAL, noASDDDID.design, na.rm = T))
...
# Update designs
cam.design <- update(cam.design, ACUPUNCTURE = x.sa$cac_use_r == 1)
ASD.design <- subset(cam.design, isASD)
DD.design <- subset(cam.design, isDD)
ID.design <- subset(cam.design, isID)
ASDDDID.design <- subset(cam.design, isASDDDID)
...
# ASD, ID, DD
svymean(~ACUPUNCTURE, noASDDDID.design, na.rm = T)
confint(svymean(~ACUPUNCTURE, noASDDDID.design, na.rm = T))
...
# Update designs
cam.design <- update(cam.design, NATUROPATHY = x.sa$cnt_use_r == 1)
ASD.design <- subset(cam.design, isASD)
DD.design <- subset(cam.design, isDD)
ID.design <- subset(cam.design, isID)
ASDDDID.design <- subset(cam.design, isASDDDID)
